...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        ...
        <!-- Add Rooms Modal Ends-->
        <!-- Edit Rooms Modal Starts-->
        ...
        <!-- Edit Rooms Modal Ends-->
        <!-- Manage Room Images Modal Starts -->
