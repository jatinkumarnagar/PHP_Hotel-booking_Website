...
<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-3">
...
<!--Footer Ends-->
<!---->
<h6 class="text-center bg-dark text-white p-3 m-0">Developed by Jatin Kumar Nagar</h6>
<!---->
...
<script>
    ...
    function checkLoginToBook(status, room_id) {
        if (status) {
            ...
            alert('error', 'Please login to book rooms!');
        }
    }
